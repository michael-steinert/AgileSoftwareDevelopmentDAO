...
const daoIntegration = async (): Promise<void> => {
    context("DAO Integration Test", async () => {
        ...
        beforeEach(async () => {
            ...
            daoGovernor = (await ethers.getContractAt("DaoGovernor", DaoGovernor.address)) as DaoGovernor;
            ...
            governanceToken = (await ethers.getContractAt("GovernanceToken", GovernanceToken.address)) as GovernanceToken;
        ...
        it.skip("should create, vote, wait, queue, and then execute the Proposal", async () => {
            ...
            /* Vote for Proposal */
            const voteTransaction = await daoGovernor.castVoteWithReason(proposalId, voteType, reason)
