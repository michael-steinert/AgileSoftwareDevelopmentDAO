...
import {
    Provider
} from '../../../../hardhat-ethers-react-ts-starter-main/hardhat-ethers-react-ts-starter-main/frontend/src/utils/provider';
...
const Balance = (): ReactElement => {
    ...
    useEffect((): CleanupFunction => {
        ...
        const getBalance = async (library: Provider, account: string): Promise<void> => {
...
const NextNonce = (): ReactElement => {
    ...
    useEffect((): CleanupFunction => {
        ...
        const getNextNonce = async (library: Provider, account: string): Promise<void> => {
